...
#pragma interface
#endif
#ifdef IMPLEMENTING_DESCRIPTORS
static const char *rcsid_Descriptors = "@(#)$Id$";
#endif /* IMPLEMENTING_DESCRIPTORS */
#include <map>
#include "TSTypes.h"
#include "BitStream.h"
...
/*
 * Desc_VideoDecodeControl
 */
class Desc_VideoDecodeControl : public BitStream {
 public:
   Desc_VideoDecodeControl();
...
/*
 * Desc_StreamIdentifier
 */
class Desc_StreamIdentifier : public BitStream {
 public:
   Desc_StreamIdentifier();
 ...
 * Desc_Service
 */
class Desc_Service : public BitStream {
 public:
   Desc_Service();
   virtual ~Desc_Service();
 ...
 * Desc_Component
 */
class Desc_Component : public BitStream {
 public:
   Desc_Component();
 ...
 * Desc_AudioComponent
 */
class Desc_AudioComponent : public BitStream {
 public:
   Desc_AudioComponent();
   const char *component_string();
   uint8 stream_content() const;
