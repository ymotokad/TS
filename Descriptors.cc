...
#include <iostream>
#include <map>
#define IMPLEMENTING_DESCRIPTORS
 ...
 * Descriptor class
 */
Id2StringMap Descriptor::descriptors;
void Descriptor::initDescriptors() {
...
const char *Descriptor::getName(uint8 tag) {
...
/*
 * Desc_VideoDecodeControl class
 */
FIELDWIDTH_PREAMBLE(Desc_VideoDecodeControl)
...
FIELDWIDTH_POSTAMBLE(Desc_VideoDecodeControl, /**/)

uint8 Desc_VideoDecodeControl::video_encode_format() const {
   return bit_field8(pos_video_encode_format);
}

const char *Desc_VideoDecodeControl::video_encode_format_string() const {
...
/*
 * Desc_StreamIdentifier class
 */
FIELDWIDTH_PREAMBLE(Desc_StreamIdentifier)
FIELDWIDTH_CONTENT(Descriptor::pos_descriptor_tag,		8)
FIELDWIDTH_CONTENT(Descriptor::pos_descriptor_length,		8)
FIELDWIDTH_CONTENT(pos_component_tag,	8)
FIELDWIDTH_CONTENT(pos_end_of_data,	0)
FIELDWIDTH_POSTAMBLE(Desc_StreamIdentifier, /**/)

uint8 Desc_StreamIdentifier::component_tag() const {
   return bit_field8(pos_component_tag);
}
const char *Desc_StreamIdentifier::component_tag_string() const {
   static char buff[8]; // This is really thread-unsafe
 ...
 * Desc_Service class
 */
FIELDWIDTH_PREAMBLE(Desc_Service)
FIELDWIDTH_CONTENT(Descriptor::pos_descriptor_tag,	8)
FIELDWIDTH_CONTENT(Descriptor::pos_descriptor_length,	8)
...
FIELDWIDTH_POSTAMBLE(Desc_Service, initvars())

void Desc_Service::initvars() {
...
uint8 Desc_Service::service_type() const {
   return bit_field8(pos_service_type);
}
const char *Desc_Service::service_type_string() const {
   static char buff[8]; // This is really thread-unsafe
...
uint8 Desc_Service::service_provider_name_length() const {
   return bit_field8(pos_service_provider_name_length);
}

const char *Desc_Service::service_provider_name_string()  {
...
/*
 * Desc_Component class
 */
FIELDWIDTH_PREAMBLE(Desc_Component)
FIELDWIDTH_CONTENT(Descriptor::pos_descriptor_tag,	8)
FIELDWIDTH_CONTENT(Descriptor::pos_descriptor_length,	8)
...
FIELDWIDTH_POSTAMBLE(Desc_Component, /**/)

const char *Desc_Component::component_string() {
...
uint8 Desc_Component::stream_content() const {
   return bit_field8(pos_stream_content);
}

uint8 Desc_Component::component_type() const {
   return bit_field8(pos_component_type);
}

uint8 Desc_Component::component_tag() const {
   return bit_field8(pos_component_tag);
}


/*
 * Desc_AudioComponent class
 */
FIELDWIDTH_PREAMBLE(Desc_AudioComponent)
FIELDWIDTH_CONTENT(Descriptor::pos_descriptor_tag,	8)
FIELDWIDTH_CONTENT(Descriptor::pos_descriptor_length,	8)
...
FIELDWIDTH_POSTAMBLE(Desc_AudioComponent, /**/)

const char *Desc_AudioComponent::component_string() {
...
uint8 Desc_AudioComponent::stream_content() const {
   return bit_field8(pos_stream_content);
}

uint8 Desc_AudioComponent::component_type() const {
   return bit_field8(pos_component_type);
}

uint8 Desc_AudioComponent::component_tag() const {
   return bit_field8(pos_component_tag);
}
